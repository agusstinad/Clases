...
def consultarPedidos ():
    while (True):
        ...
        if (stock >= cantidadProducto):
            ...
            URL_MENSAJE_TELEGRAM= "https://api.telegram.org/bot1973714579:AAG3CP2ukyX2nYgToC5VCw-E5p7AXnF7Vvg/sendMessage?chat_id=-520657802&text=El pedido pudo procesarse correctamente."
            ...
            URL_MENSAJE = "https://api.telegram.org/bot1973714579:AAG3CP2ukyX2nYgToC5VCw-E5p7AXnF7Vvg/sendMessage?chat_id=-520657802&text=El pedido no pudo procesarse, el stock no es el suficiente."
